...
function makeTest(){
    ...
    //Instructions
    const inst0 = document.createElement("h2");
    inst0.setAttribute("class", "instructions");
    inst0.innerHTML = "Check all that apply";

    const inst1 = document.createElement("h3");
    inst1.setAttribute("class", "instructions");
    inst1.innerHTML = "Have you ever...";

    const element = document.getElementById(id); //adds instruction
    element.appendChild(inst0);
    element.appendChild(inst1);
    ...
    for(var j = 0; j < masterQuestions.length; j++){
        ...
        const inst2 = document.createElement("h3"); // displays the level
        inst2.setAttribute("class", "instructions");
        inst2.innerHTML = "(Level " + (j+1) + ")";
        element.appendChild(inst2);
...
function animate0(){
    document.getElementById("topNav").className = "topNavHidden";
